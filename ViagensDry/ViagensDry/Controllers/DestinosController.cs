...
namespace ViagensDry.Controllers
{
    public class DestinosController : Controller
    {
        ...
        public DestinosController(BancoDados context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdDestino,LugarDestino,DiaPartida")] Destino destino)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdDestino,LugarDestino,DiaPartida")] Destino destino)
        {
